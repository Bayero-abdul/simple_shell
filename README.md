...
### Introduction
This repository is a [Alx software engineering school](https://www.alxafrica.com/software-engineering/) Project. The school project consisted in writing a shell like sh (Bourne Shell) by Stephen Bourne  , in **C**, using a limited number of standard library functions, So Instead we used ower own function that we rewrited over the past three month [Here](https://github.com/Bayero-abdul/alx-low_level_programming)
...
`` git clone https://github.com/Bayero-abdul/simple_shell ``
